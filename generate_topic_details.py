...
with open("topic_evidence_selections.json", "w", encoding="utf-8") as f:
...
DETAIL_DIR = Path("details")
DETAIL_DIR.mkdir(exist_ok=True)

DETAIL_DRAFT_DIR = Path("details/drafts")
DETAIL_DRAFT_DIR.mkdir(exist_ok=True)

DETAIL_EDITED_DIR = Path("details/edited")
DETAIL_EDITED_DIR.mkdir(exist_ok=True)

with open("prompts/topic_details_generation.txt", "r", encoding="utf-8") as f:
    instr_topic_details_generation = f.read()

with open("topic_evidence_selections.json", "r", encoding="utf-8") as f:
...
print("\n### Faithfulness Check and Minimal Edit of Topic Details ###")
